...
from HardwareInterface.lib_nrf24 import NRF24  # import NRF24 library

GPIO.setmode(GPIO.BCM)  # set the gpio mode

# set the pipe address. this address shoeld be entered on the receiver alo

pipes = [[0xBB, 0xF0, 0xF0, 0xF0, 0xF0], [0xAA, 0xF0, 0xF0, 0xF0, 0xF0]]

radio = NRF24(GPIO, spidev.SpiDev())  # use the gpio pins

radio.begin(0, 6)  # start the radio and set the ce,csn pin ce= GPIO8, csn= GPIO6

radio.setPayloadSize(32)  # set the payload size as 32 bytes

radio.setChannel(8484848490)  # set the channel as 76 hex
